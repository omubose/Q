<footer class="footer">
      <nav class="footer__nav">
        <ul class="footer__list">
          <li class="footer__item"><a href="<?php echo esc_url(home_url('/#about')); ?>">バラックについて</a></li>
          ...
          <li class="footer__item"><a href="<?php echo esc_url(home_url('/#access')); ?>">アクセス</a></li>
        </ul>
      </nav>
      <div class="footer__logo-card">
        <div class="footer__camp-logo">
          <a href="<?php echo esc_url( home_url() ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/img/camp-logo.png" alt="" /></a>
        </div>
